...
?>
	<tr>
	<td></td><td></td><td></td><td></td><td></td><td align="center">TOTAL</td><td align="center"><?php $sql = "SELECT SUM(8mm) FROM steel";
						$result = $conn->query($sql);
 ...
 ?>
</td><td align="center"><?php $sql = "SELECT SUM(10mm) FROM steel";
						$result = $conn->query($sql);
 ...
 ?></td><td align="center"><?php $sql = "SELECT SUM(12mm) FROM steel";
						$result = $conn->query($sql);
 ...
 ?></td><td align="center"><?php $sql = "SELECT SUM(16mm) FROM steel";
						$result = $conn->query($sql);
 ...
 ?></td><td align="center"><?php $sql = "SELECT SUM(20mm) FROM steel";
						$result = $conn->query($sql);
 ...
 ?></td><td align="center"><?php $sql = "SELECT SUM(25mm) FROM steel";
						$result = $conn->query($sql);
